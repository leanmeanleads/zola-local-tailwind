...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try
		{
			xhr.open(request.aM, request.V, true);
		}
		catch (e)
		{
			return callback(_Scheduler_fail($elm$http$Http$BadUrl(request.V)));
		}
...
function _Http_toResponse(xhr)
{
	return {
		V: xhr.responseURL,
		aS: { aE: xhr.status, l: xhr.statusText },
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ae: fragment, ag: host, ak: path, am: port_, ap: protocol, R: query};
	});
...
var $author$project$Main$ChooseMaterial = 0;
var $author$project$Main$firstStage = 0;
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function () {
	var defaultMaterial = 0;
	var defaultArea = 0;
	var quote = A2($author$project$Main$calculateQuote, defaultMaterial, defaultArea);
	return _Utils_Tuple2(
		A7($author$project$Main$Model, 'rails', _List_Nil, $elm$core$Maybe$Nothing, $author$project$Main$firstStage, defaultMaterial, defaultArea, quote),
...
var $elm$http$Http$expectJson = function (decoder) {
	return $elm$http$Http$expectStringResponse(
		function (response) {
			var _v0 = A2($elm$json$Json$Decode$decodeString, decoder, response.aA);
			if (_v0.$ === 1) {
...
var $author$project$Main$GetQuote = 2;
var $author$project$Main$SelectArea = 1;
var $author$project$Main$orderedStages = _List_fromArray(
	[0, 1, 2]);
...
var $author$project$Main$indexOfStage = function (currentStage) {
	return A2(
		$elm$core$Maybe$withDefault,
		0,
		A2($elm_community$list_extra$List$Extra$elemIndex, currentStage, $author$project$Main$orderedStages));
};
var $author$project$Main$nextStage = function (currentStage) {
	return A2(
		$elm$core$Maybe$withDefault,
		$author$project$Main$firstStage,
		A2(
			$elm_community$list_extra$List$Extra$getAt,
			$author$project$Main$indexOfStage(currentStage) + 1,
			$author$project$Main$orderedStages));
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							a: $author$project$Main$nextStage(model.a)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							a: $author$project$Main$previousStage(model.a)
						}),
					$elm$core$Platform$Cmd$none);
			case 0:
				var value = msg.a;
			...
			case 1:
				return _Utils_Tuple2(
					model,
					$author$project$Main$getRepos(model.R));
			default:
...
var $author$project$Main$stageCompleteOrActive = F2(
	function (currentStage, stage) {
		var stageIndex = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm_community$list_extra$List$Extra$elemIndex, stage, $author$project$Main$orderedStages));
		var currentStageIndex = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm_community$list_extra$List$Extra$elemIndex, currentStage, $author$project$Main$orderedStages));
		return _Utils_cmp(stageIndex, currentStageIndex) < 1;
	});
...
var $author$project$Main$renderStep = F2(
	function (model, stageDescription) {
		var textClass = A2($author$project$Main$stageCompleteOrActive, model.a, stageDescription.a) ? ' text-white ' : ' text-gray-500 ';
		var progressBar = (!stageDescription.a) ? _List_Nil : (A2($author$project$Main$stageCompleteOrActive, model.a, stageDescription.a) ? _List_fromArray(
			[
				A2(
				$elm$html$Html$div,
				_List_fromArray(
		...
		var borderClass = A2($author$project$Main$stageCompleteOrActive, model.a, stageDescription.a) ? '  ' : ' border-2  border-gray-500 ';
		var backgroundClass = A2($author$project$Main$stageCompleteOrActive, model.a, stageDescription.a) ? ' bg-green-500 ' : ' bg-white ';
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(stageDescription._)
						]))
				]));
	});
var $author$project$Main$StageDescription = F2(
	function (stage, description) {
		return {_: description, a: stage};
	});
var $author$project$Main$stageDescriptions = _List_fromArray(
	[
		A2($author$project$Main$StageDescription, 0, 'Material'),
		A2($author$project$Main$StageDescription, 1, 'Area'),
		A2($author$project$Main$StageDescription, 2, 'Quote')
	]);
...
var $author$project$Main$Concrete = 2;
var $author$project$Main$Resin = 1;
var $author$project$Main$Tarmac = 3;
var $author$project$Main$NextStage = {$: 3};
...
var $author$project$Main$PreviousStage = {$: 4};
...
var $author$project$Main$actions = function (model) {
	return _Utils_ap(
		$author$project$Main$previousButton(model.a),
		$author$project$Main$nextButton(model.a));
};
...
var $author$project$Main$renderChooseMaterial = function (model) {
	var visibleClass = (!model.a) ? '' : 'hidden';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_Utils_ap(
			_List_fromArray(
				[
					A3($author$project$Main$materialSelection, model, 0, '/assets/img/block-driveway.png'),
					A3($author$project$Main$materialSelection, model, 1, '/assets/img/resin-driveway.png'),
					A3($author$project$Main$materialSelection, model, 2, '/assets/img/concrete-driveway.png'),
					A3($author$project$Main$materialSelection, model, 3, '/assets/img/tarmac-driveway.png')
				]),
...
var $author$project$Main$Large = 2;
...
var $author$project$Main$renderSelectArea = function (model) {
	var visibleClass = (model.a === 1) ? '' : 'hidden';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_Utils_ap(
			_List_fromArray(
				[
					A2($author$project$Main$areaSelection, model, 0),
					A2($author$project$Main$areaSelection, model, 1),
					A2($author$project$Main$areaSelection, model, 2)
				]),
			$author$project$Main$actions(model)));
};
